...
for run in range(n_runs):
    ...
    for gen in range(ini_g+1, ngens):
        ...
        # df.loc[index] = [experiment_name, enemy, run, gen, mean, fit_pop[best]]
    ...
    # store best weights of the run
    # best_weights_arr[run] = best_weights
...
# store best weights in csv file
# np.savetxt(experiment_name+'/best_weights.csv', 
#             best_weights_arr, delimiter=', ')
